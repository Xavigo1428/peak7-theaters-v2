...
import { PlusCircle, Database, Film, ListOrdered } from "lucide-react";

export default function AdminDashboardView() {
  return (
    <div className="w-full max-w-5xl mx-auto flex flex-col gap-8 animate-fade-in py-12 text-center items-center">
      ...
      <div className="flex flex-col items-center gap-3">
        ...
        <p className="text-sm text-white/60 leading-relaxed max-w-xl">
          Welcome to the theater lounge management area. Please select an option below to add a new title, manage the catalog, or rank the trending list.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full mt-4">
        ...
        {/* Card 3: Manage Top 10 */}
        <Link
          to="/admin/manage-top-10"
          className="group relative bg-surface-container-low border border-white/5 p-8 flex flex-col items-center gap-4 hover:border-red-600/40 hover:shadow-[0_10px_30px_rgba(229,9,20,0.15)] hover:scale-[1.03] transition-all duration-300 rounded-xl cursor-pointer"
        >
          <div className="w-16 h-16 rounded-full bg-red-600/10 text-red-500 group-hover:bg-red-600 group-hover:text-white transition-all duration-300 flex items-center justify-center">
          ...
          <div className="text-center">
            ...
            <p className="text-xs text-white/60 leading-relaxed">
              Quickly reorder and assign the top 10 trending movies shown on the featured homepage banner and lists.
            </p>
          </div>
        </Link>
      </div>
